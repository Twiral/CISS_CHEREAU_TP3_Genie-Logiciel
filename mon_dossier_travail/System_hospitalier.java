...
public class System_hospitalier {
    ...
    private String analyserRequete(Requête requête) {
        //Après avoir reçu les documments contenant les symptomes des patients, on analyse les requêtes de ces derniers
        return "requête analysée";
    }

    private String comparerDonnes() {
        //Dans le système hospitalier, on a la possibilité de comparer les données des différents patients.
